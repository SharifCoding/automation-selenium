...
public class operatorRandomMultiplyPage extends basePage{
  ...
  public void input_first_random_value() { 
	MobileElement first_input = mobiledriver.findElement(By.id("com.google.android.calculator:id/digit_" + mMultiplyRandomOne));
  ...
  public void input_second_random_value() {
	MobileElement second_input = mobiledriver.findElement(By.id("com.google.android.calculator:id/digit_" + mMultiplyRandomTwo));
